...
import static com.yuxin.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
...
//        User user = this.baseMapper.selectAllByUserAccountAndUserPassword(userAccount, encryptPassword).get(0);
        // 用户不存在
        if (user == null) {
